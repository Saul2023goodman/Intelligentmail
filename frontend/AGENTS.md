...
- Open every page with the shared `PageHeader` (`src/app/page-header.tsx`) and size chrome from the `src/app/viewport.css` density variables. Do not add a page-local title block, page-title sizing, or fixed pixel header/toolbar padding.
