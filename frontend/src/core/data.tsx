...
const MUTATION_IMPACTS: Record<string, string[]> = {
  ...
  followup_configure: ["followup_workspace", "workspace", "execution_workspace", "records_workspace", "records_task"],
  followup_process: ["followup_workspace", "workspace", "review_workspace", "execution_workspace", "records_workspace", "records_task"],
  ...
  refresh_mailbox: ["workspace", "mailbox_workspace", "mailbox_history", "followup_workspace", "records_workspace", "records_task"],
